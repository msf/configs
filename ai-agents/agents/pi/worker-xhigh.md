---
name: worker-xhigh
description: High-reasoning general-purpose implementation subagent, full capabilities, isolated context. Use for complex, multi-file implementation tasks that are not suited to the default worker.
